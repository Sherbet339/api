...
function editStudent(){ 
    ...
    // students.id=`${id}`
    // idd=students.id
    // students.name = document.getElementById('nameInput').value 
    // students.surname = document.getElementById('surnameInput').value 
    // students.studentId = document.getElementById ('studentIdInput').value 
    // students.gpa = document.getElementById ('gpaInput').value 
    // students.image = document.getElementById ('imageLinkInput').value
    editStudentDB() 
}
